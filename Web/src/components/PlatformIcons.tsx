export function WindowsIcon({ className }: { className?: string }) {
  return (
    <svg fill="currentColor" strokeWidth="0" viewBox="0 0 448 512" className={className}>
...
export function LinuxIcon({ className }: { className?: string }) {
  return (
    <svg fill="currentColor" stroke="currentColor" strokeWidth="0" viewBox="0 0 448 512" className={className}>
...
export function AndroidIcon({ className }: { className?: string }) {
  return (
    <svg fill="currentColor" strokeWidth="0" viewBox="0 0 24 24" className={className}>
...
export function AndroidTvIcon({ className }: { className?: string }) {
  return (
    <svg fill="currentColor" strokeWidth="0" viewBox="0 0 24 24" className={className}>
