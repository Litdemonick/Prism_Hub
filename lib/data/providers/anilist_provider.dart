...
class AniListProvider {
  static String get anilistToken {
    return PrismHubStorage.getSetting(SettingKey.aniListToken);
  }

  static String get userid {
    return PrismHubStorage.getSetting(SettingKey.aniListUserId);
  }
  ...
  static Future<Map<String, dynamic>> getuserData() async {
    ...
    PrismHubStorage.setSetting(SettingKey.aniListUserId, userId);
